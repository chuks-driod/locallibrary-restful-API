...
var swaggerOptions = {
  ...
  apis:['app.js', './controllers/authorController.js', './controllers/bookController.js', './controllers/bookinstanceController.js', './controllers/genreController.js'],
};
...
app.use('/catalog/api-docs', swaggerUI.serve, swaggerUI.setup(swaggerDocs))
